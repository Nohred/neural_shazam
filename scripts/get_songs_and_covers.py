...
songs = [
    ...
    ("deadmau5_monophobia", "https://www.youtube.com/watch?v=NESCd6IFfLM"),
    ("the_prodigy_breathe", "https://www.youtube.com/watch?v=rmHDhAohJlQ"),
    ...
    #  Regional Mexicano
    ("vicente_fernandez_el_rey", "https://www.youtube.com/watch?v=zhHrefOdlLs"),
    ("pedro_infante_cien_anos", "https://www.youtube.com/watch?v=fqfFPEToslA"),
    ("los_tigres_del_norte_la_puerta_negra", "https://www.youtube.com/watch?v=rryDND06LHU"),
    ("banda_ms_el_color_de_tus_ojos", "https://www.youtube.com/watch?v=7UO0O6ADu4Q"),
    ("christian_nodal_adios_amor", "https://www.youtube.com/watch?v=ETLoTxVVvjM"), 

    #  Indie / Alternativo
    ("arctic_monkeys_do_i_wanna_know", "https://www.youtube.com/watch?v=bpOSxM0rNPM"),
    ("tame_impala_the_less_i_know_the_better", "https://www.youtube.com/watch?v=2SUwOgmvzK4"),
    ...
    #  Clásica
    ("beethoven_symphony_no5_1stmovement", "https://www.youtube.com/watch?v=B7pQytF2nak"),
    ...
    ("Masego + FKJ - Tadow", "https://www.youtube.com/watch?v=zwf5MpcuKDM"),
    ("dave_brubeck_take_five", "https://www.youtube.com/watch?v=tT9Eh8wNMkw"),
    ("louis_armstrong_what_a_wonderful_world", "https://www.youtube.com/watch?v=rBrd_3VMC3c"),
    ...
    ("bob_marley_no_woman_no_cry", "https://www.youtube.com/watch?v=IT8XvzIfi4U"),
